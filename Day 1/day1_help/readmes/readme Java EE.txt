...
Read --HTTP basics including request & response structure from day2-data\day2_help\j2ee_prerequisites\HTTP Basics
...
URL : http://host:port/day2.1/validate?....
...
eg URL --http://host:port/day2_web/hello
